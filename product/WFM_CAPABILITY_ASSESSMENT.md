...
| `CAP-SUP-001` | Staffing supply — opening HC, attrition, hiring, training, handoff | Strong | Long-range planners/recruiting partners; close monthly supply gaps | `staffingModel.js`, grouped sticky native supply worksheet, `PLAN-008`–`PLAN-010`, date/count/handoff and Chromium geometry tests | No skill mix, recruiting capacity constraints, cost, or probabilistic yield | Requirements, calendars | Retain; add scenario comparison before more inputs | High | 5/4/4/4/4/4 | 20 | 2026-07-19 |
...
| `CAP-SCEN-001` | Scenario planning — versioned plans, updates, and comparison | Strong saved-plan workflow | Planning leads; preserve Budget, create Updates, select current plan, and compare saved operating scenarios | Plan lifecycle, immutable snapshots, required Update reasons, monthly demand/capacity driver attribution, comparison dialog/complete CSV, `PLAN-013`, `ACT-004`–`ACT-006`, focused and Chromium tests | No explicit what-if branching or parameter-sensitivity generator; legacy Updates can lack rationale | Forecast versions, plan lineage | Retain; add branching only after a concrete decision workflow is established | High | 5/4/4/4/4/4 | 20 | 2026-07-19 |
...
| `CAP-UX-001` | Desktop operational UX — dense, keyboard/mouse planning workflows | Adequate-to-strong | All planner personas; scan, edit, compare, and act efficiently on desktop | Shared wrappers, native tables, split center workspace, visible annual-plan readiness, driver-explained saved-plan comparison, sticky keyboard-scrollable call-center and supply worksheets, focus-safe dialogs, standards/Chromium tests | Keyboard shortcuts, persistent context in remaining dense worksheets, focus restoration in unreviewed workflows, and zoom review are uneven | Shared UI system and workflow-specific testing | Improve within roadmap slices; decline phone-specific work | Medium | 5/3/4/3/4/3 | 32 | 2026-07-19 |
