...
| `CAP-FORE-002` | Forecasting — statistical forecast workbench | Strong, governance pending | Forecast analysts; train, inspect, adjust, validate, compare, and save daily forecasts | `ForecastingWorkspace.vue`, contact/AHT and rolling-origin accuracy modules, saved-candidate comparison, traceable manual demand adjustments, `FCAST-001`–`FCAST-005`, diagnostic CSVs, focused/backend/browser tests | No governed acceptance/rejection record; legacy saved rules can still lack rationale until edited | Clean history and operating calendar; acceptance policy evidence from `INT-002` | Retain the workbench; define governed acceptance evidence under `NEXT-004` after `INT-002` | High | 5/4/4/4/4/4 | 20 | 2026-07-19 |
