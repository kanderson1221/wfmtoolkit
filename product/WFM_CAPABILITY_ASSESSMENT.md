...
| `CAP-GOV-001` | Governance — lineage, finalization, destructive safeguards, auditability | Adequate | WFM leads/data owners; understand sources, preserve baselines, avoid data loss | Immutable plan demand snapshots, current-plan lineage, focus-safe destructive confirmations, backup recovery metadata | No user/event audit log, approvals, ownership, or formal change reasons across all records | Shared identity and persistence | Improve lineage/decision notes now; full audit with server persistence | Medium | 4/3/4/3/3/4 | 26 | 2026-07-19 |
...
| `CAP-UX-001` | Desktop operational UX — dense, keyboard/mouse planning workflows | Adequate-to-strong | All planner personas; scan, edit, compare, and act efficiently on desktop | Shared wrappers, native tables, split center workspace, focus-safe confirmation contract, standards tests | Keyboard shortcuts, sticky comparison context, focus restoration outside shared confirmations, and zoom review are uneven | Shared UI system and workflow-specific testing | Improve within roadmap slices; decline phone-specific work | Medium | 5/3/4/3/4/3 | 32 | 2026-07-19 |
