...
| `CAP-UX-001` | Desktop operational UX — dense, keyboard/mouse planning workflows | Adequate-to-strong | All planner personas; scan, edit, compare, and act efficiently on desktop | Shared wrappers, native tables, split center workspace, visible annual-plan step readiness, sticky keyboard-scrollable call-center reconciliation, focus-safe confirmations and Update creation, standards/Chromium tests | Keyboard shortcuts, persistent context in unreviewed worksheets, focus restoration in unreviewed workflows, and zoom review are uneven | Shared UI system and workflow-specific testing | Improve within roadmap slices; decline phone-specific work | Medium | 5/3/4/3/4/3 | 32 | 2026-07-19 |
