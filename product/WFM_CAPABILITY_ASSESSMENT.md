...
| `CAP-FORE-002` | Forecasting — statistical forecast workbench | Adequate, improving | Forecast analysts; train, inspect, adjust, validate, compare, and save daily forecasts | `ForecastingWorkspace.vue`, contact/AHT accuracy and saved-candidate comparison modules, traceable manual demand adjustments, `FCAST-001`–`FCAST-004`, leakage-safe holdout benchmarks, diagnostic CSVs, focused and Chromium tests | No rolling-origin validation or governed acceptance/rejection record; legacy saved rules can still lack rationale until edited | Clean history and operating calendar; acceptance policy evidence from `INT-002` | Continue `NOW-005`; define governed acceptance evidence after `INT-002` | High | 5/3/4/4/4/4 | 25 | 2026-07-19 |
