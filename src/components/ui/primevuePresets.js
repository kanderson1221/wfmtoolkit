...
export const tableFieldInputClass =
  'w-full rounded-md border border-slate-200 bg-slate-50/70 px-2 py-1.5 text-center text-sm tabular-nums text-slate-900 shadow-none outline-none transition placeholder:text-slate-400 focus:bg-white focus:border-sky-400 focus:ring-2 focus:ring-sky-100'
