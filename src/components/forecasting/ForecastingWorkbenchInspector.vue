...
const inspectorHelp = {
  ...
  defaultCap: 'Default upper forecast limit used when the trend shape is logistic. This limit applies to all days unless a daily ceiling column is provided in the uploaded file.',
  defaultFloor: 'Default lower forecast limit used when the trend shape is logistic. This floor applies to all days unless a daily floor column is provided in the uploaded file.',
