        ...
        <table class="assumption-table assumption-table-presence-main">
          ...
          <thead>
            ...
            <tr class="presence-detail-row">
              ...
              <th title="Planned time off hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Planned Off</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Unplanned absence hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Unplanned</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Leave hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Leave</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Meeting hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Meetings</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Training hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Training</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Coaching hours per agent for the month.">
                <span class="presence-head-label">
                  <span>Coaching</span>
                  <span class="presence-head-unit">hrs/mo</span>
                </span>
              </th>
              <th title="Paid break hours per agent per business day. These daily hours are reduced by presence before they hit utilization.">
                <span class="presence-head-label">
                  <span>Breaks</span>
                  <span class="presence-head-unit">hrs/day</span>
                </span>
              </th>
              <th title="Other away time per agent per business day. These daily hours are reduced by presence before they hit utilization.">
                <span class="presence-head-label">
                  <span>Away</span>
                  <span class="presence-head-unit">hrs/day</span>
                </span>
