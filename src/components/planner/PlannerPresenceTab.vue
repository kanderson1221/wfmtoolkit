...
const summaryItems = computed(() => [
  {
    label: 'Avg FTE Paid Hours',
    value: props.formatNumber(props.summary.averageMonthlyPaidHoursPerFte, 1)
  },
  {
    label: 'Avg FTE Workdays',
    value: props.formatNumber(props.summary.averageFteWorkdays, 1)
  },
  {
  ...
  { label: 'Average Presence', value: props.formatPercent(props.summary.averagePresence, 1) }
])
</script>
...
<template>
  <section class="monthly-tab-panel">
    ...
    <AppStatStrip :items="summaryItems" columns="md:grid-cols-4 xl:grid-cols-7" />
        ...
        <table class="assumption-table assumption-table-presence-main">
          ...
          <thead>
            <tr class="presence-super-row">
              ...
              <th colspan="2" class="presence-super-head presence-super-calendar" title="Monthly and per-shift paid capacity for one FTE.">FTE Capacity</th>
              ...
              <th colspan="5" class="presence-super-head presence-super-results" title="Derived workdays, loss totals, and final availability percentages.">Results</th>
            </tr>
            <tr class="presence-detail-row">
              <th class="presence-detail-head presence-detail-calendar" title="Scheduled or contracted paid hours for one FTE in the month, before availability losses are removed.">
                <span class="presence-head-label">FTE Paid<br />Hours</span>
              </th>
              <th class="presence-detail-head presence-detail-calendar" title="Full paid hours for one agent in one worked shift before paid breaks are removed.">
                <span class="presence-head-label">Shift Paid<br />Hours</span>
              </th>
              ...
              <th class="presence-detail-head presence-detail-utilization" title="Paid break hours per agent per worked day. These daily hours are reduced by presence before they hit utilization.">
                <span class="presence-head-label">
                  <span>Breaks</span>
                  <span class="presence-head-unit">hrs/day</span>
                </span>
              </th>
              <th class="presence-detail-head presence-detail-utilization" title="Other away time per agent per worked day. These daily hours are reduced by presence before they hit utilization.">
                <span class="presence-head-label">
                  <span>Away</span>
                  <span class="presence-head-unit">hrs/day</span>
                </span>
              </th>
              <th class="presence-detail-head presence-detail-results" title="Derived employee workdays, calculated as monthly FTE paid hours divided by shift paid hours.">
                <span class="presence-head-label">FTE Work<br />Days</span>
              </th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="presence-calendar-cell presence-input-cell presence-input-calendar">
                <AppTableNumberField
                  v-model.number="presenceMonths[record.monthIndex].monthlyPaidHoursPerFte"
                  :min="0"
                  :step="0.01"
                  :min-fraction-digits="1"
                  :max-fraction-digits="2"
                  aria-label="Monthly paid hours per FTE"
                />
              </td>
              <td class="presence-calendar-cell presence-input-cell presence-input-calendar">
                <AppTableNumberField
                  ...
                  :min-fraction-digits="1"
                  :max-fraction-digits="2"
                  aria-label="Paid hours per worked shift"
                />
              </td>
              ...
              <td class="presence-input-cell presence-input-other">
                <AppTableNumberField
                  ...
                  :min-fraction-digits="1"
                  :max-fraction-digits="2"
                  aria-label="Paid breaks hours per agent per worked day"
                />
              </td>
              <td class="presence-input-cell presence-input-other">
                <AppTableNumberField
                  ...
                  :min-fraction-digits="1"
                  :max-fraction-digits="2"
                  aria-label="Other away hours per agent per worked day"
                />
              </td>
              <td class="presence-result-cell">{{ props.formatNumber(record.fteWorkdays, 1) }}</td>
