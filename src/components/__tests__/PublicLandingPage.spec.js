...
describe('PublicLandingPage', () => {
  it('introduces the toolkit and available tools for search visitors', () => {
    ...
    expect(wrapper.text()).toContain('From demand signal to staffing decision.')
    expect(wrapper.text()).toContain('Recorded manual change')
    expect(wrapper.text()).toContain('Actuals & variance')
    expect(wrapper.text()).toContain('8/8 future months')
    ...
    expect(wrapper.text()).toContain('Review Planning Tools')
