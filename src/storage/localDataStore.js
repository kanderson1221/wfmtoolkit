    ...
    ;(center.groups || []).forEach((group) => {
      ...
      ;(group.plans || []).forEach((plan) => {
        planRows.push({
          ...
          intradayErlangResults: clonePlain(plan.intradayErlangResults || null),
          actualsIntradayErlangResults: clonePlain(plan.actualsIntradayErlangResults || null),
  ...
  rows.planRows.forEach((row) => {
    ...
    plansByGroupId.set(row.groupId, [
      ...existingPlans,
      {
        ...
        intradayErlangResults: clonePlain(row.intradayErlangResults || null),
        actualsIntradayErlangResults: clonePlain(row.actualsIntradayErlangResults || null),
