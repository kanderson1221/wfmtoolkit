...
- Decision this answer will influence: Which holdout periods, additional candidate configurations, acceptance record, and warning thresholds should govern the remaining `NOW-005` workflow after the leakage-safe weekday benchmark first slice.
